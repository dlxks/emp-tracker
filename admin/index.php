                    ...
                    <div class="col-12 col-md-4 py-2">
                        <div class="card ">
                            ...
                            <div class="card-body">
                                ...
                                <a href="administrators.php" class="custom-btn custom-btn-sm">Show users <i class="fa-solid fa-caret-right"></i></a>
                            </div>
                    ...
                    <div class="col-12 col-md-4 py-2">
                        <div class="card ">
                            ...
                            <div class="card-body">
                                ...
                                <a href="coordinators.php" class="custom-btn custom-btn-sm">View pending accounts <i class="fa-solid fa-caret-right"></i></a>
                            </div>
                            <div class="card-footer text-light bg-custom-lightorange">
                    ...
                    <div class="col-12 col-md-4 py-2">
                        <div class="card ">
                            ...
                            <div class="card-body">
                                ...
                                <a href="branches.php" class="custom-btn custom-btn-sm">View branches <i class="fa-solid fa-caret-right"></i></a>
                            </div>
                            <div class="card-footer text-light bg-custom-lightorange">

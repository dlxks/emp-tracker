...
<head>
   ...
   <link rel="stylesheet" href="404/assets/css/errStyle.css">
   <link rel="icon" type="image/x-icon" href="../images/cvsu_logo.png">
   <title>ERROR 404</title>
   <!-- <script src="404/assets/js/errBabel.js"></script> -->
</head>
...
<body>
   <main>
      ...
      <table>
         <tr><br></tr>
         <tr>
            <td><a id="errorLink" href="students/student_dashboard.php">Home</a></td>
            <td><a id="errorLink" onclick="history.back()">Go Back</a></td>
